...
rl.question('¿Qué mes quieres mirar? (formato 01 al 12): ', (mes) => {
  const link = `https://www.basquetcatala.cat/partits/calendari_club_mensual/3331/${mes}`;
  console.log(`El link para el mes ${mes} es: ${link}`);
  
  // Aquí puedes continuar con el resto de tu lógica, por ejemplo, iniciar Puppeteer
  (async () => {
    ...
    const personas = [
      ...
      //{ nombre: 'Agusti', disponible: true, categoria: '1A. TERRITORIAL SÈNIOR MASCULÍ', equip: 'BÀSQUET SANT SADURNÍ' },   // Agusti esta retirado
